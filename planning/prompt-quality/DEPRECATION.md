...
- `planning/prompt-quality/prompt-quality-execution-program.v2.json` is the Task registry, dependency, and completion-claim authority;
- trusted normalized Git and GitHub Actions evidence determines whether a persisted completion claim is authoritative;
...
Local-only validation cannot authorize Task completion or unlock dependent Tasks.
