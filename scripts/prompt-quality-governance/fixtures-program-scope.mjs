...
import {validateScope,scopeHash} from './scope-progress.mjs';
...
else if(c==='valid_amendment'){const old=s.scope_revision;s.amendments=[{revision:'sha256:'+'a'.repeat(64),previous_revision:old,reason:'fixture',authorization_commit_sha:'a'.repeat(40),added_paths:['fixture/path']}];s.committed_paths.push('fixture/path');s.scope_revision=scopeHash(s);z.push(...await validateScope(s,{actual:s.committed_paths}))}
