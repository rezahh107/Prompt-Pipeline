export class RendererError extends Error { constructor(message:string, public readonly exitCode:number, public readonly category:string, public readonly details:string[] = []) { super(message); this.name="RendererError"; } }
