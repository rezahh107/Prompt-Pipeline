...
export interface ReasonSnapshot { snapshot_schema:string; source_protocol_version:string; source_inspector_repository:string; source_inspector_commit:string; sources:{registry:CompatibilitySource;projection:CompatibilitySource;projection_core:CompatibilitySource;constants:CompatibilitySource}; transformation:string; selected_fields_sha256:string; canonical_status_by_effect:CanonicalStatusMapping[]; candidate_status_by_technical_status:CandidateStatusMapping[]; candidate_reason_by_canonical:CandidateReasonMapping[]; canonical_reasons:CanonicalReason[]; candidate_reason_domains:CandidateReason[] }
